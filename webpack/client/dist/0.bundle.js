...
let NegociacaoService = class NegociacaoService {
    ...
    obtemNegociacoesDaSemana() {
        ...
        return this._http.get(`${"http://localhost:3000"}/negociacoes/semana`).the(dados => dados.map(objeto => new __WEBPACK_IMPORTED_MODULE_1__Negociacao_js__["a" /* Negociacao */](new Date(objeto.data), objeto.quantidade, objeto.valor)), err => {
            throw new __WEBPACK_IMPORTED_MODULE_2__util_ApplicationException_js__["a" /* ApplicationException */]('Não foi possível obteras negociações');
        });
    }
